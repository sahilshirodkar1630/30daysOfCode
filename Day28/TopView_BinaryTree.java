...
public class TopView_BinaryTree {
	...
	public static void main(String[] args) {
		...
		BinaryTreeNode<Integer> root = takeInputLevelWise();
		 ArrayList<Integer> output =  topViewBinaryTree(root);
	...
	private static ArrayList<Integer> topViewBinaryTree(BinaryTreeNode<Integer> root) {
	...
	private static void helper(BinaryTreeNode<Integer> root, int position) {
		...
		while(!queue.isEmpty()) {
			...
			if(!map.containsKey(frontNode.position)) {
